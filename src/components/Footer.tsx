...
const SocialIcon = ({ d }: { d: string }) => (
  <a href="#" className="text-slate-dark-custom hover:text-accent-red transition-colors">
    ...
    <footer className="bg-navy-dark py-14">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            <img src={tichLogo} alt="Tich" className="h-7 mb-4 brightness-0 invert" />
            <p className="text-slate-dark-custom text-sm mb-5">The structured marketplace for fashion vendors.</p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {footerLinks.quick.map((l) => (
                <li key={l.label}>
                  <a href={l.href} className="text-slate-dark-custom text-sm hover:text-soft-white transition-colors">{l.label}</a>
                </li>
              ))}
            </ul>
          </div>
